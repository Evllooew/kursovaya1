public class Main {
    public static void main(String[] args) {
        ...
        employees[0] = new Employee("Иван Иванов", 1, 939);
        employees[1] = new Employee("Иван1 Иванов", 2, 257);
        employees[2] = new Employee("Иван2 Иванов", 1, 452);
        employees[3] = new Employee("Иван3 Иванов", 3, 127);
        employees[4] = new Employee("Иван4 Иванов", 2, 486);
        employees[5] = new Employee("Иван5 Иванов", 4, 788);
        employees[6] = new Employee("Иван6 Иванов", 3, 355);
        employees[7] = new Employee("Иван7 Иванов", 5, 255);
        employees[8] = new Employee("Иван8 Иванов", 1, 459);
